...
from lincutter import config, events
from lincutter.menubar import AppMenubar
from lincutter.toolbar import AppToolbar
from lincutter.tools import AppTools
from lincutter.statusbar import AppStatusbar
from lincutter.context import ContextPanel
...
class MainWindow(gtk.Window):
	...
	def __init__(self, app):
		...
		self.context = ContextPanel(self)
